"""
Django settings for ticktolk project.
...
SECRET_KEY = 'rp!*bj5op20!i$#f*&ip&+%**goi2#a6y*+g@rgo&k8wlfdj6r'
...
ROOT_URLCONF = 'ticktolk.urls'

WSGI_APPLICATION = 'ticktolk.wsgi.application'
